...
<body>
    ...
    <div class="product-grid-container">
        ...
        $sql = "SELECT * FROM productos WHERE categoria = 'conjuntos'";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($product = $result->fetch_assoc()) {
                ...
                // Ruta de la imagen
                $imagenPath = "img/conjuntos/" . $codigo . ".jpeg";
            ...
            echo "<p>No hay productos disponibles en la categoría 'conjuntos'.</p>";
        }
