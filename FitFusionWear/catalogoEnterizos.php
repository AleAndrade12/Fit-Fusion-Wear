...
<body>
    ...
    <div class="product-grid-container">
        ...
        $sql = "SELECT * FROM productos WHERE categoria = 'enterizos'";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($product = $result->fetch_assoc()) {
                ...
                // Ruta de la imagen
                $imagenPath = "img/enterizos/" . $codigo . ".jpeg";
            ...
            echo "<p>No hay productos disponibles en la categoría 'enterizos'.</p>";
        }
